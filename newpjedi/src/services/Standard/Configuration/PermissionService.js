...
const getUnCreatedPermissionType = async () => {
  try {
    return await axios.get('/api/permission/get-uncreated-permission-type');
  } catch (error) {
    console.log(`ERROR: ${error}`);
  }
};
...
export { getPermissionTypeArr, getUnCreatedPermissionType, getPermissionList, createPermission, modify };
